 ...
 */
class PathedDateTimeNormalizer implements NormalizerInterface, DenormalizerInterface, CacheableSupportsMethodInterface
{
    ...
    public function denormalize($data, $type, $format = null, array $context = [])
    {
        ...
        try {
            ...
            if($context['disable_type_type_enforcement'] ?? false){
                return $data;
            }
